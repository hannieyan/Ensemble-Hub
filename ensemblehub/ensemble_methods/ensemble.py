...
from ..generators.api_engine import APIGenerator
    ...
    def ensemble(
        ...
        **kwargs
        ...
        for spec in model_specs:
            ...
            # For non-API engines, try to get existing Ray actor
            if engine != "api":
                try:
                    ...
                    # Actor doesn't exist, will create new one below
                    pass
            
            # Create new generator based on engine type
            if engine == "api":
                # Use API generator directly without Ray
            ...
            logger.info(f"✅ Created new {engine} generator: {spec['path']}")
            generators[spec["path"]] = generator
