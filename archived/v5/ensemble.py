...
from v5.data.template import get_template_and_fix_tokenizer
from v5.hparams import DataArguments
from v5.data.converter import AlpacaDatasetConverter
...
class HFGenerator(BaseGenerator):
    ...
    def generate(self, dicts, *, max_tokens=64, temperature=0.95, top_p=0.7) -> GenOutput:
        ...
        txt = _trim_text(txt) if not ended else txt
        print(txt, ended)
